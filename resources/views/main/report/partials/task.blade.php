<fieldset>
    <div class="form-group">
        <div class="col-sm-1">
            <label class="control-label">Task</label><br />
            {{--<a ng-if="$index > 0" class="btn btn-danger btn-sm"><em class="icon-close"></em></a>--}}
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                ...
                <label class="radio-inline">
                    <input type="radio" required name="grade" value="D"> D
                </label>
                <label class="radio-inline">
                    <input type="radio" required name="grade" value="E"> E
                </label>
            </div>
        </div>
